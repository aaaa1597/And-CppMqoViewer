...
/* CG3DViewer */
/**************/
JNIEXPORT jboolean JNICALL Java_com_tks_cppmqoviewer_CG3DViewerActivity_init(JNIEnv *env, jclass clazz, jobject assetmanager, jobjectArray objectArray) {
...
/* MQO */
/*******/
JNIEXPORT jboolean JNICALL Java_com_tks_cppmqoviewer_modelformat_MQO_init(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL Java_com_tks_cppmqoviewer_modelformat_MQO_setDrawArea(JNIEnv *env, jclass clazz, jint width, jint height) {
	CG3DViewer::setDrawArea(width, height);
	return;
}

JNIEXPORT void JNICALL Java_com_tks_cppmqoviewer_modelformat_MQO_draw(JNIEnv *env, jclass clazz) {
	CG3DViewer::draw();
	return;
}

JNIEXPORT void JNICALL Java_com_tks_cppmqoviewer_modelformat_MQO_setTouchAngle(JNIEnv *env, jclass clazz, jfloat aTouchAngleX, jfloat aTouchAngleY) {
	CG3DViewer::setTouchAngle(aTouchAngleX, aTouchAngleY);
	return;
}

JNIEXPORT void JNICALL Java_com_tks_cppmqoviewer_modelformat_MQO_setScale(JNIEnv *env, jclass clazz, jfloat scale) {

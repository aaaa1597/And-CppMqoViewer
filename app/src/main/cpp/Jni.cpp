...
JNIEXPORT void JNICALL Java_com_tks_cg3dviewer_modelformat_MQO_setTouchAngle(JNIEnv *env, jclass clazz, jfloat aTouchAngleX, jfloat aTouchAngleY) {
	CG3DViewer::setTouchAngle(aTouchAngleX, aTouchAngleY);
	return;
}

JNIEXPORT void JNICALL Java_com_tks_cg3dviewer_modelformat_MQO_setScale(JNIEnv *env, jclass clazz, jfloat scale) {
